...
<script>
    ...
    function calcHeight(){
        setTimeout(function(){
            ...
            var the_height= document.getElementById('m-newspaper').contentWindow.document.body.scrollHeight;

            alert(the_height);

            document.getElementById('m-newspaper').height= the_height;
...
*/
    window.addEventListener('message', function(e) {
        document.getElementById('m-newspaper').height= e.data.childData;
