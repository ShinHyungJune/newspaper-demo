            ...
            <div class="inner">
                ...
                <div class="cont-main">
                    ...
                    <div class="khquiz khrank mainarea">
                        <ul class="maintab">
                            <a href="/answers/create" class="active" data-tab="maintab_1">
                                퀴즈 풀기
                                <i class="xi-angle-down"></i>
                            </a>
                            <a href="/pointHistories?type=퀴즈정답" class="" data-tab="maintab_2">
                                퀴즈 랭킹
                                <i class="xi-angle-down"></i>
                            </a>
                            <a href="/questions" class="" data-tab="maintab_3">
                                퀴즈 내역
                                <i class="xi-angle-down"></i>
                            </a>
                        </ul>
                            ...
                            <div class="khquiz_area">
                                ...
                                <div class="quizlist" v-for="(question, index) in questions.data" :key="question.id" v-if="index == form.activeIndex && question.answer">
                                    ...
                                    <div class="quiz_a">
                                        ...
                                        <div class="quiz_btm">
                                            <a :href="question.url" target="_blank">관련 기사 보러가기</a>
                                        </div>
                                    </div>
                                </div>
                                <!-- //정답확인 -->
                                ...
                                <div class="quizlist" v-if="questions.data.length !== 0 && form.activeIndex == questions.data.length">
                                    ...
                                    <div class="quiz_a_main">
                                        <p class="quiz_total_txt">
                                            <span>홍길동</span>님, 오늘 <span>{{questions.data.length}}</span>개의 퀴즈 중 <span>{{countCorrect}}</span>개를 맞추셨어요!
                                        </p>
